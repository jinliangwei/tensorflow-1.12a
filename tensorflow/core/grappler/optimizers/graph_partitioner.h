...
#ifndef TENSORFLOW_CORE_GRAPPLER_OPTIMIZERS_GRAPH_PARTITIONER_H_
#define TENSORFLOW_CORE_GRAPPLER_OPTIMIZERS_GRAPH_PARTITIONER_H_
...
class GraphPartitioner : public GraphOptimizer {
 public:
  ...
  explicit GraphPartitioner(
      RewriterConfig::MemOptType optimization_level)
    : optimization_level_(optimization_level) { }
  ~GraphPartitioner() override {}

  string name() const override { return "graph_partitioner"; };
...
#endif  // TENSORFLOW_CORE_GRAPPLER_OPTIMIZERS_GRAPH_PARTITIONER_H_
